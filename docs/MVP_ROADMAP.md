...
Foundation (shipped)
  ...
  → Stint 1 Open the Floor — 1.1–1.4 shipped; next 1.5
...
**Current:** 1.1–1.4 shipped. Next: **1.5** Admin subscription manage APIs.
...
| 1.5 | Subscriptions: Admin payment status + start override (+ later addon attach). Accept already snapshots base (± addon) lines. | `memberships` | A8, A8b, A19, C10 | Gym-owned | Todo |
...
**Client integration (shipped through 1.4):** [`client-auth.md`](client-auth.md) · [`membership-invites.md`](membership-invites.md)
