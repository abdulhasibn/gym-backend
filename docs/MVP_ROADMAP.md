...
**Current:** 3.1 shipped (food catalog + diet + diary + gym diet templates,
ADR-0008). Exercise catalog seed live (ADR-0007). Next: 3.2 workout
assign/complete APIs. A8b addon attach / renew deferred within 1.5.
