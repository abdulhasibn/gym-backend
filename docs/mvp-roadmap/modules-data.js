...
window.MODULES_DATA = [
  ...
  },
  {
    ...
    summary:
      "Search catalog ExerciseItem → days → sets/reps with notes. Same addon gate and grant rules as diet (WORKOUT_PLANS for adherence). ADR-0007.",
    howItWorks: [
      "Assign from the seed catalog while addon is in-date. No typed exercise names.",
      "Client marks sessions/exercises complete per calendar day (not logged sets).",
    ...
    detail: {
      ...
      howItWorks: [
        "Mirrors diet ownership and grant rules. Catalog identity is ExerciseItem (ADR-0007).",
        "Reassignment preserves plan history within the gym provenance model.",
      ],
      acceptance: ["Addon-gated assign from catalog + Client daily complete works end-to-end."],
      prdRefs: "C6, T6, T7, T8 · PRD §5.5 · §5.13 · ADR-0007",
    },
  },
  {
    id: "M8",
